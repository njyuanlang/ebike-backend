 ...
 * List Controller
 */
App.controller('ListCtrl', ["$scope", "$modal", function ListCtrl($scope, $modal) {
  $scope.entities = []
...
App.controller('CreateModalInstanceCtrl', ["$scope", "$modalInstance", function ($scope, $modalInstance) {
